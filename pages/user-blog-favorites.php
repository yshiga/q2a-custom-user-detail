<?php
    ...
    // ブログのお気に入り
    $blog_favorites_start = ($action === 'blogs-favorites') ? $start : 0;
    $blog_favorites_sel = cud_user_blog_favorites_selectspec( $loginuserid, $identifyier, $pagesize, $blog_favorites_start);
